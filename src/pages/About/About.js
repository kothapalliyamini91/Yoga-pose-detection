    ...
    return (
        ...
        <div className="about-container">
            ...
            <div className="about-main">
                ...
                <h2>This Project Done BY : </h2>
                <ol>
                    <li class="project-mem">A. Teja (S170931)</li>
                    <li class="project-mem"> N .  Alekhya (S170755)</li>
                    <li class="project-mem">K .  Yamini (S170547)</li>
                </ol>
                <p className="about-content">Copyright © Rajiv Gandhi University of knowledge and techonlogies- Srikakulam </p>
